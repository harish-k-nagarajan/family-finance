...
function ThemeToggle({ user, currentTheme }) {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-gray-200 dark:border-white/10 bg-gray-100 dark:bg-navy-600 hover:bg-gray-200 dark:hover:bg-navy-500 transition-colors text-sm font-medium text-gray-700 dark:text-gray-200"
